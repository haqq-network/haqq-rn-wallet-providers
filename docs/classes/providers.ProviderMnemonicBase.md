[@haqq/rn-wallet-providers - v0.0.11](../README.md) / [Exports](../modules.md) / [providers](../modules/providers.md) / ProviderMnemonicBase

# Class: ProviderMnemonicBase

[providers](../modules/providers.md).ProviderMnemonicBase
...
- [`ProviderBase`](providers.ProviderBase.md)\<[`ProviderMnemonicBaseOptions`](../modules/providers.md#providermnemonicbaseoptions)\>
...
- [constructor](providers.ProviderMnemonicBase.md#constructor)

### Properties

- [\_options](providers.ProviderMnemonicBase.md#_options)
- [captureRejectionSymbol](providers.ProviderMnemonicBase.md#capturerejectionsymbol)
- [captureRejections](providers.ProviderMnemonicBase.md#capturerejections)
- [defaultMaxListeners](providers.ProviderMnemonicBase.md#defaultmaxlisteners)
- [errorMonitor](providers.ProviderMnemonicBase.md#errormonitor)

### Methods

- [[captureRejectionSymbol]](providers.ProviderMnemonicBase.md#[capturerejectionsymbol])
- [abort](providers.ProviderMnemonicBase.md#abort)
- [addListener](providers.ProviderMnemonicBase.md#addlistener)
- [catchError](providers.ProviderMnemonicBase.md#catcherror)
- [clean](providers.ProviderMnemonicBase.md#clean)
- [emit](providers.ProviderMnemonicBase.md#emit)
- [eventNames](providers.ProviderMnemonicBase.md#eventnames)
- [getAccountInfo](providers.ProviderMnemonicBase.md#getaccountinfo)
- [getIdentifier](providers.ProviderMnemonicBase.md#getidentifier)
- [getMaxListeners](providers.ProviderMnemonicBase.md#getmaxlisteners)
- [getMnemonicPhrase](providers.ProviderMnemonicBase.md#getmnemonicphrase)
- [getPrivateKey](providers.ProviderMnemonicBase.md#getprivatekey)
- [isMnemonicSaved](providers.ProviderMnemonicBase.md#ismnemonicsaved)
- [listenerCount](providers.ProviderMnemonicBase.md#listenercount)
- [listeners](providers.ProviderMnemonicBase.md#listeners)
- [off](providers.ProviderMnemonicBase.md#off)
- [on](providers.ProviderMnemonicBase.md#on)
- [once](providers.ProviderMnemonicBase.md#once)
- [prependListener](providers.ProviderMnemonicBase.md#prependlistener)
- [prependOnceListener](providers.ProviderMnemonicBase.md#prependoncelistener)
- [rawListeners](providers.ProviderMnemonicBase.md#rawlisteners)
- [removeAllListeners](providers.ProviderMnemonicBase.md#removealllisteners)
- [removeListener](providers.ProviderMnemonicBase.md#removelistener)
- [setMaxListeners](providers.ProviderMnemonicBase.md#setmaxlisteners)
- [setMnemonicSaved](providers.ProviderMnemonicBase.md#setmnemonicsaved)
- [signPersonalMessage](providers.ProviderMnemonicBase.md#signpersonalmessage)
- [signTransaction](providers.ProviderMnemonicBase.md#signtransaction)
- [signTypedData](providers.ProviderMnemonicBase.md#signtypeddata)
- [updatePin](providers.ProviderMnemonicBase.md#updatepin)
- [addAbortListener](providers.ProviderMnemonicBase.md#addabortlistener)
- [getAccounts](providers.ProviderMnemonicBase.md#getaccounts)
- [getEventListeners](providers.ProviderMnemonicBase.md#geteventlisteners)
- [getMaxListeners](providers.ProviderMnemonicBase.md#getmaxlisteners-1)
- [initialize](providers.ProviderMnemonicBase.md#initialize)
- [listenerCount](providers.ProviderMnemonicBase.md#listenercount-1)
- [on](providers.ProviderMnemonicBase.md#on-1)
- [once](providers.ProviderMnemonicBase.md#once-1)
- [setMaxListeners](providers.ProviderMnemonicBase.md#setmaxlisteners-1)
- [shareToSeed](providers.ProviderMnemonicBase.md#sharetoseed)

## Constructors

### constructor

• **new ProviderMnemonicBase**(`options`)

#### Parameters

| Name | Type |
| :------ | :------ |
| `options` | [`ProviderMnemonicBaseOptions`](../modules/providers.md#providermnemonicbaseoptions) & [`ProviderBaseOptions`](../modules/providers.md#providerbaseoptions) |
...
▸ **addListener**\<`K`\>(`eventName`, `listener`): [`ProviderMnemonicBase`](providers.ProviderMnemonicBase.md)
...
[src/providers/mnemonic/provider.ts:120](https://github.com/haqq-network/haqq-rn-wallet-providers/blob/69c5710/src/providers/mnemonic/provider.ts#L120)
...
set by `emitter.setMaxListeners(n)` or defaults to [defaultMaxListeners](providers.ProviderMnemonicBase.md#defaultmaxlisteners).
...
▸ **off**\<`K`\>(`eventName`, `listener`): [`ProviderMnemonicBase`](providers.ProviderMnemonicBase.md)
...
▸ **on**\<`K`\>(`eventName`, `listener`): [`ProviderMnemonicBase`](providers.ProviderMnemonicBase.md)
...
▸ **once**\<`K`\>(`eventName`, `listener`): [`ProviderMnemonicBase`](providers.ProviderMnemonicBase.md)
...
▸ **prependListener**\<`K`\>(`eventName`, `listener`): [`ProviderMnemonicBase`](providers.ProviderMnemonicBase.md)
...
▸ **prependOnceListener**\<`K`\>(`eventName`, `listener`): [`ProviderMnemonicBase`](providers.ProviderMnemonicBase.md)
...
▸ **removeAllListeners**(`eventName?`): [`ProviderMnemonicBase`](providers.ProviderMnemonicBase.md)
...
▸ **removeListener**\<`K`\>(`eventName`, `listener`): [`ProviderMnemonicBase`](providers.ProviderMnemonicBase.md)
...
▸ **setMaxListeners**(`n`): [`ProviderMnemonicBase`](providers.ProviderMnemonicBase.md)
